...
CDialogChooser::CDialogChooser()
{
	...
	m_pDlgs[2] = new CClassesDlg; 

	m_nCurrDlg = 0;
	// TODO: Connect the new classes dialog to your custom AppWizard.
	//  You'll want to add it to your CDialogChooser's internal array
	//  here in the constructor, and update the values of LAST_CUSTOM_STEP
	//  below, and LAST_DLG in Chooser.h
