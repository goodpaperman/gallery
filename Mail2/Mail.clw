...
NewFileInclude2=#include "Mail.h"
LastPage=0
...
Type=0
HeaderFile=Mail.h
ImplementationFile=Mail.cpp
Filter=N

[CLS:CMailDoc]
Type=0
HeaderFile=MailDoc.h
ImplementationFile=MailDoc.cpp
Filter=N

[CLS:CMailView]
Type=0
HeaderFile=MailView.h
ImplementationFile=MailView.cpp
Filter=C
