========================================================================
                    CUSTOM APPWIZARD: AppWizard
========================================================================


AppWizard has created a AppWizard DLL for you.  This DLL is the starting point
...
you build AppWizard.awx, it will automatically be copied to your Template
...
AppWizardAw.h, AppWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CAppWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into AppWizard.rc.  Be
