...
void CMainFrame::OnEditCalculate() 
{
	// TODO: Add your command handler code here
      CProgressDlg dlg;
    
      dlg.Create();  // By default Create will disable the application's main window
      ...
      for(int i=0; i<10; i++)    
      {
        ...
        dlg.StepIt();            // iteration of the processing
       }

      // At this point either the operation has completed or the user has cancelled.
      CString str; 
      str.Format("Calculation result is: %d.", rand()); 
      AfxMessageBox(str); 
}

void CMainFrame::DoSingleCalculation(int nIndex)
{
    Sleep(500); 
}
